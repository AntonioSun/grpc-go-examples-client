...
func TestEntryDetail(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response, err := c.GetEntryInfo(ctx,
				&pb.EntryDetailRequest{EntryId: "5983fea7-c3b7-4ac5-a469-9326992d5c90"})
...
const entryDetail = `{"id":"5983fea7-c3b7-4ac5-a469-9326992d5c90","title":"quis ipsam atque","code":"quis-ipsam-atque","description":"Ea saepe asperiores delectus voluptatum aut laboriosam. Sequi minima ad cupiditate ad nisi quidem. Non molestiae fugit.","file_url":"https://grpc-techunits.ams3.digitaloceanspaces.com/uploads/5983fea7-c3b7-4ac5-a469-9326992d5c90/6cfc7e87-d316-40eb-9df2-fcb5b2efbcc5.png","created_on":1651783674,"modified_on":1651783674}`
